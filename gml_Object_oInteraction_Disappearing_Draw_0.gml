if (((floor(DisappearFrame / 2) % 2) == 0 || DisappearFrame < 15) && CanAppear)
{
    ...
    var Columns = 5;
    var Rows = 1;
    var Texture = sprite_get_texture(sMaze_Kids, 0);
...
if (DisappearFrame >= 30)
    instance_destroy();

if (room != MinigameMaze_1 && (currently_ultimate() && has_been_ultimate()))
    CanAppear = true;

if (point_distance(x, y, oCamera3DMaze.x, oCamera3DMaze.y) < 160)
    Disappearing = true;
