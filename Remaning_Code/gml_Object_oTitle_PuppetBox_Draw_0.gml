...
vertex_set_point(VertexBuffer, fx(rightmost, bottom), fy(rightmost, bottom), fz(24), 1, 1);

repeat (2)
{
    vertex_set_point(VertexBuffer, fx(right, bottom), fy(right, bottom), fz(upper), 1, 0.5);
    vertex_set_point(VertexBuffer, fx(rightmost, top), fy(rightmost, top), fz(24), 0, 1);
}

vertex_set_point(VertexBuffer, fx(right, top), fy(right, top), fz(upper), 0, 0.5);
vertex_end(VertexBuffer);
vertex_submit(VertexBuffer, pr_trianglelist, sprite_get_texture(sTitleTex_PuppetBox, 0));
