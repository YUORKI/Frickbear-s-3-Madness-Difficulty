...
draw_3d_sign(x1, y1, x2, y2, (Height + (sprite_get_height(Sprite) / 8)) * VerticalStretch, Height, sprite_get_texture(Sprite, ImageIndex), 1, 1);
VerticalStretch += ((1 - VerticalStretch) / 10);
