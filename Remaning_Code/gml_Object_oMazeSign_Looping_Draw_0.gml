...
while (s < image_xscale)
{
    ...
    var zBottom = (Height - (HeightOffset * 32)) + 24;
    var zTop = zBottom + sprite_get_height(Sprite);
    var zBottomNext = (Height - (sin(((s + 0.5) / image_xscale) * pi) * 32)) + 24;
    var zTopNext = zBottomNext + sprite_get_height(Sprite);
