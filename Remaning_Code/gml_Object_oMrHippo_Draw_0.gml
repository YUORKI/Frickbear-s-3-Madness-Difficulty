...
var x1 = _x + (192 * dcos(Angle) * ScaleSize);
var y1 = _y + (192 * dsin(Angle) * ScaleSize);
var x2 = _x - (192 * dcos(Angle) * ScaleSize);
var y2 = _y - (192 * dsin(Angle) * ScaleSize);
var zTop = (256 + (256 * ScaleSize)) - YOffset;
var zBottom = 256 - (256 * ScaleSize) - YOffset;
var TextureX = 0;
var TextureWidth = 1;
var Texture = sprite_get_texture(sMrHippoOffice, 0);
