Selected = -1;
MinigameArray = [oMinigame_FreddyFazsweep, oMinigame_AirAdventure, oMinigame_ChicasFeedingFrenzy, oMinigame_PuppetPatrol, oMinigame_HarePairs, oMinigame_PiratePlunder, oMinigame_CircusSorter, oMinigame_GoldenFazsweep, oMinigame_MangleTangleMania, oMinigame_CupcakeClicker, oMinigame_ScottsSlots];
MinigameNames = ["Fredsweeper", "Air Adventure", "Chomping With Chica", "Puppet Patrol", "Hare Pairs", "Pirate Plunder", "Circus Sorter", "Golden Fredsweeper", "Mangle Tangle Mania", "Cupcake Clicker", "Scott's Slots"];
