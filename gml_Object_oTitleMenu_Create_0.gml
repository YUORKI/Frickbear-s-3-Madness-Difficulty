...
function goto_menu(arg0, arg1)
{
    ...
    switch (arg0)
    {
        ...
        case "Difficulty":
            ...
            array_push(CurrentOptions, "Madness");
        ...
        case "Gameplay":
            CurrentOptions = ["Lock Mouse in Window", "Mouse Sensitivity (Freeroam)", "View Bobbing (Freeroam)", "Game Timer", "Back"];
            OptionsMenu = 3;
            CurrentDesc = "";
            break;
