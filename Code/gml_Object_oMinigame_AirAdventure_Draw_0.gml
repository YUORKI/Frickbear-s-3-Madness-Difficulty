...
if (mouse_check_button_pressed(mb_left) && mouse_in_minigame_window() && !(Dead || Paused) && WaitFrames == 0)
{
    BBSpeed = -2.5;
    Started = true;
    ...
    with (oAA_BB)
    {
        ...
        else if (other.Passing)
        {
            with (other)
            {
                ...
                global.TokensPerMinigame[UnknownEnum.Value_1] += Multiplier;
                ...
                if (Score > global.HiScores[UnknownEnum.Value_1])
                    global.HiScores[UnknownEnum.Value_1] = Score;
                
                if (Score > global.HiScoresOverall[UnknownEnum.Value_1])
                    global.HiScoresOverall[UnknownEnum.Value_1] = Score;
                
                if (Score == 30)
                    get_trophy(UnknownEnum.Value_2);
            }
        }
    }
