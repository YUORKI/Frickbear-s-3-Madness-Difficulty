depth = 325 + (dsin(BobFrame) * 10);
image_angle = BaseAngle + HeightOffset + (dsin(BobFrame * 2) * 10);

with (instance_nearest(x, y, oTitle_HangingDecor_Office_Salvage))
    ValleyHeight = 96 - (dsin(other.BobFrame) * 10);
