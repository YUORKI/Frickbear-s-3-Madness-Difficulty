if (global.AILevels[UnknownEnum.Value_14] == 0 && global.Cam == UnknownEnum.Value_7)
{
    depth = 85;
    draw_sprite(sCameras_BB, 0, global.CamX, global.CamY);
}
...
var TextureX = 0;
var TextureWidth = 1;
var Texture = sprite_get_texture(sBBOffice, 0);
