...
if (input_check_pressed(UnknownEnum.Value_0) && place_meeting(x, y + 1, oAnimdude_Wall))
{
    YVelocity = -3 * Speed;
...
if (x > 304)
{
    ...
    y = 96;
    Level++;
    generate_level(Level % array_length(LevelQueue));
    add_tokens(1);
...
if (y > 160 || place_meeting(x, y, oAnimdude_Hazard) || StuckOnWallCounter > 180)
{
    x = -96;
    y = 96;
    StuckOnWallCounter = 0;
    ...
    if (Lives == 0)
        jumpscare(UnknownEnum.Value_41, 0);
}
