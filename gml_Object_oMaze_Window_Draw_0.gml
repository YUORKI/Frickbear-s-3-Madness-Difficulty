var Texture = sprite_get_texture(sMazeTex_Doorway, 0);
...
var _z0 = Bottom;
var _z1 = Top;
var _z2 = Top - BarWidth;
var _z3 = Bottom + BarWidth;

repeat (2)
{
    vertex_set_point(VertexBuffer, fx(_x1sub, _y1), fy(_x1sub, _y1), fz(_z3), 1, 1);
    ...
    vertex_set_point(VertexBuffer, fx(_x2sub, _y1), fy(_x2sub, _y1), fz(_z3), 1, 1);
    ...
    repeat (2)
    {
        vertex_set_point(VertexBuffer, fx(_x2, _y1), fy(_x2, _y1), fz(_z0), 1, 0);
        vertex_set_point(VertexBuffer, fx(_x1sub, _y1), fy(_x1sub, _y1), fz(_z3), 0.75, 1);
    }
    
    vertex_set_point(VertexBuffer, fx(_x1, _y1), fy(_x1, _y1), fz(_z0), 0.75, 0);
    _y1 *= -1;
}
...
vertex_set_point(VertexBuffer, fx(_x1, _y1), fy(_x1, _y1), fz(_z0), 1, 1);
vertex_set_point(VertexBuffer, fx(_x1sub, _y2), fy(_x1sub, _y2), fz(_z3), 1, 1);
...
vertex_set_point(VertexBuffer, fx(_x2sub, _y2), fy(_x2sub, _y2), fz(_z3), 1, 1);
