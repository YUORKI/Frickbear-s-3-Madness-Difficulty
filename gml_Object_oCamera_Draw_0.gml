...
if (Freeze)
{
    CameraXTo += ((x - CameraXTo) / 5);
    CameraYTo += ((y - 32 - CameraYTo) / 5);
    CameraZTo += ((275 - CameraZTo) / 5);
}
else
{
    CameraXTo += ((CamXToTarget - CameraXTo) / 15);
    CameraYTo += ((CamYToTarget - CameraYTo) / 15);
    CameraZTo += ((CamZToTarget - CameraZTo) / 15);
}
